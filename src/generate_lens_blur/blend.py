...
def get_images(sourcefolder, method, route, batch):
    ...
    for photo in filenames:
        ...
        black_img = cv2.imread("../images/orig/CIFAR_" + batch + "/" + photo)
        white_img = cv2.imread("../images/blur/CIFAR_" + batch + "/" + photo)
        if method == 'forward':
            mask_img = "../blur_mask/blur_" + str(route) + ".png"
        else:
            mask_img = "../blur_mask/blur_rev_" + str(route) + ".png"
    ...
    for method in ['reverse']:
        ...
        for route in range(2, 11):
            for batch in ['data_batch_1', 'data_batch_2', 'data_batch_3', 'data_batch_4', 'data_batch_5', 'test_batch']:
                #input_dir = "../images/orig/CIFAR_" + batch
                #output_dir = "../images/blur/CIFAR_" + batch
                sourcefolder = "../images/orig/CIFAR_" + batch
                outfolder = "../images/new/CIFAR_" + batch + "_" + method + "_" + str(route)
                ...
                for photo, white_img, black_img, mask_img in get_images(sourcefolder, method, route, batch):
